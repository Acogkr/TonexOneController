# TONEX ONE Controller hardware reference

> Wiring details on this page originate from the former C firmware. The current
> Rust firmware models these combinations as 22 build variants over 13 reusable
> hardware profiles. Compilation is verified; physical validation status is
> tracked in [`docs/rust-migration/verification.md`](docs/rust-migration/verification.md).
