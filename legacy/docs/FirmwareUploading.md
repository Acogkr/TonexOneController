# Legacy release flashing reference

> Archived migration evidence: the binaries and instructions below belong to
> the former mixed-device C releases. Do not use them as TONEX ONE-only Rust
> firmware releases. Rust release flashing instructions will be published only
> after physical hardware validation.
