# Legacy C firmware development reference

> Archived migration evidence: this document describes the former mixed-device
> C firmware under `source/`. It is not the build guide for the current
> TONEX ONE-only Rust firmware. Use
> [`docs/rust-migration/development-environment.md`](docs/rust-migration/development-environment.md)
